...
MeasureExtension.prototype.load = function() {
    ...
    this.calibrationTool = new Autodesk.Viewing.Extensions.Measure.CalibrationTool(viewer, this.options, this.sharedMeasureConfig, this.snapper);
    viewer.toolController.registerTool(this.calibrationTool);

    this.magnifyingGlass = new Autodesk.Viewing.Extensions.Measure.MagnifyingGlass(viewer);
...
MeasureExtension.prototype.openCalibrationRequiredDialog = function (initiator) {
    if (this.hasUI) {
        if (!this.CalibrationRequiredDialog) {
            this.CalibrationRequiredDialog = new Autodesk.Viewing.Extensions.Measure.CalibrationRequiredDialog(this, this.viewer, "calibration-required", "Calibration Required", this.options );
        }
    ...
    if (initiator === 'measure') {
        ...
        this.activateInitiator = function() {
            this.viewer.dispatchEvent({ type: Autodesk.Viewing.Extensions.Markups.Core.FINISHED_CALIBRATION_FOR_DIMENSION_EVENT });
            this.activateInitiator = null;
        };
    }
};
...
MeasureExtension.prototype.createUI = function()
{
    ...
    this.measureToolbar = new Autodesk.Viewing.Extensions.Measure.MeasureToolbar(this);
...
(function(){ 'use strict';
    ...
    Autodesk.Viewing.Extensions.Measure.MeasurementsManager = MeasurementsManager;
...
(function(){ 'use strict';
    ...
    Autodesk.Viewing.Extensions.Measure.Indicator = function(viewer, measurement, tool)
    {
        this.viewer = viewer;
    ...
    var proto = Autodesk.Viewing.Extensions.Measure.Indicator.prototype;
...
(function(){ 'use strict';
    ...
    Autodesk.Viewing.Extensions.Measure.MeasureToolIndicator = MeasureToolIndicator;
...
Autodesk.Viewing.Extensions.Measure.MeasureTool = function( viewer, options, sharedMeasureConfig, snapper )
{
    ...
    Autodesk.Viewing.Private.injectCSS('extensions/Measure/Measure.css');
...
(function(){ 'use strict';
    ...
    {
        Autodesk.Viewing.Extensions.Measure.Indicator.call(this, viewer, measurement, calibrationTool);
    ...
    CalibrationToolIndicator.prototype = Object.create(Autodesk.Viewing.Extensions.Measure.Indicator.prototype);
    ...
    proto.destroy = function() {
        ...
        Autodesk.Viewing.Extensions.Measure.Indicator.prototype.destroy.call(this);
    ...
    Autodesk.Viewing.Extensions.Measure.CalibrationToolIndicator = CalibrationToolIndicator;
...
//
//
Autodesk.Viewing.Extensions.Measure.CalibrationTool = function( viewer, options, sharedMeasureConfig, snapper)
{   
    var av = Autodesk.Viewing;
    var avem = Autodesk.Viewing.Extensions.Measure;
    var MeasureCommon = Autodesk.Viewing.MeasureCommon;
    ...
    this.register = function()
    {
        if (_hasUI && !_calibrationPanel) {
            _calibrationPanel = new Autodesk.Viewing.Extensions.Measure.CalibrationPanel( this, _viewer, "calibration-panel", "Calibration", _options );
...
(function() {
    ...
    var CalibrationPanel = function(calibrationTool, viewer, id, title, options)
    {
        ...
        this.unitList = new avp.OptionDropDown("Unit type", this.tbody, unitNames, 0);
    ...
    var CalibrationRequiredDialog = function(measureExt, viewer, id, title, options)
    {
        ...
        var text = "Before using the ruler, the scale for this sheet needs to be set and calibrated.";
...
Autodesk.Viewing.Extensions.Measure.MagnifyingGlass = function(viewer) {
    ...
    this.updateMagnifyingGlass = function() {
        ...
        _viewer.removeEventListener(Autodesk.Viewing.RENDER_PRESENTED_EVENT, this.updateMagnifyingGlassBinded);
    };
    ...
    this.requestUpdate = function() {
        if(!_viewer.hasEventListener(Autodesk.Viewing.RENDER_PRESENTED_EVENT, this.updateMagnifyingGlassBinded)) {
            _viewer.addEventListener(Autodesk.Viewing.RENDER_PRESENTED_EVENT, this.updateMagnifyingGlassBinded);
        }
    };
...
(function(){ 'use strict';
    ...
    Autodesk.Viewing.Extensions.Measure.MeasureToolbar = MeasureToolbar;
