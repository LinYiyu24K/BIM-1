...
(function(){ 'use strict';
    ...
    namespace.MARKUP_DEFAULT_STROKE_WIDTH_IN_PIXELS = 1;
    namespace.MARKUP_DEFAULT_FONT_WIDTH_IN_PIXELS = 10;
    namespace.MARKUP_DEFAULT_HITAREAS_MARGIN_IN_PIXELS = 15;
    namespace.EDIT_FRAME_DEFAULT_MARGIN = 7;
    ...
    namespace.createMarkupGroupSvg = function(children) {
        children = children || [];
    ...
    namespace.createMarkupFromSVG = function(child, editor) {
        ...
        if (typeof meta !== 'string') {
            ...
            switch(type) {
                ...
                case namespace.MARKUP_TYPE_CALLOUT:
                    position = getPosition();
                    size = getSize();
                    text = getText();
                    var isFrameUsed = getIsFrameUsed();
                    createMarkup = new namespace.CreateCallout(editor, id, position, size, text, style, isFrameUsed);
                    break;
                ...
                case namespace.MARKUP_TYPE_DIMENSION:
                    firstAnchor = getAttributeVector('firstAnchor');
                    secondAnchor = getAttributeVector('secondAnchor');
                    text = getText();
                    createMarkup = new namespace.CreateDimension(editor, id, firstAnchor, secondAnchor, text, style);
                    break;
    ...
    */
    namespace.simplify = function(points, tolerance, highestQuality) {
...
(function(){ 'use strict';
    ...
    proto.onMouseUp = function() {
        ...
        movements = namespaceUtils.simplify(movements, cameraDiagSq * 0.00000001, true);
...
(function(){ 'use strict';
    ...
    namespace.MARKUP_TYPE_CALLOUT = "callout";
    namespace.MARKUP_TYPE_DIMENSION = "dimension";
...
(function(){ 'use strict';
    ...
    proto.updateStyle = function() {
        ...
        namespaceUtils.setAttributeToMarkupSvg(shape, 'stroke-linecap', 'round');
        ...
        this.boundingBox = { x: this.size.x + strokeWidth, y: this.size.y + strokeWidth };
    };
...
(function(){ 'use strict';
 ...
 (function () { 'use strict';
    ...
    function EditFrame(containingDiv, editor) {
        ...
        this.frameMargin = namespaceUtils.EDIT_FRAME_DEFAULT_MARGIN;
    ...
    proto.setMarkup = function (markup) {
        ...
        if (markup) {
            ...
            this.frameMargin = boundingBox.margin !== undefined ? boundingBox.margin : namespaceUtils.EDIT_FRAME_DEFAULT_MARGIN;
    ...
    proto._handleRightClickDown = function(event) {
        ...
        if (!av.isMobileDevice() && avp.isRightClick(event, this.editor.viewer.navigation)) {
...
(function(){ 'use strict';
    ...
    function MarkupCallout(id, editor, size) {
        ...
        namespace.Markup.call(this, id, editor, styleAttributes);
        this.type = namespace.MARKUP_TYPE_CALLOUT;
        this.textShape = namespaceUtils.createMarkupTextSvg();
        this.rectShape = namespaceUtils.createMarkupPathSvg();
        this.shape = namespaceUtils.createMarkupGroupSvg([this.rectShape, this.textShape]);
    ...
    MarkupCallout.prototype = Object.create(namespace.Markup.prototype);
    ...
    proto.getEditMode = function() {
        ...
        return new namespace.EditModeCallout(this.editor);
    };
    ...
    proto.updateStyle = function() {
        ...
        namespaceUtils.setAttributeToMarkupSvg(text, 'font-family', fontFamily);
            namespaceUtils.setAttributeToMarkupSvg(text, 'font-size', fontSize * FONT_SIZE_SCALE);
        namespaceUtils.setAttributeToMarkupSvg(text, 'fill', strokeColor);
        namespaceUtils.setAttributeToMarkupSvg(text, 'font-weight', fontWeight);
        namespaceUtils.setAttributeToMarkupSvg(text, 'font-style', fontStyle);

        namespaceUtils.setMarkupTextSvgTransform(text, textContainerTransform, textTransform);
        namespaceUtils.updateMarkupTextSvgClipper(text, textSize.x, textSize.y);
        namespaceUtils.updateMarkupTextSvgHitarea(text, textSize.x, textSize.y, editor);
        ...
        if (this.isFrameUsed) {
            ...
            namespaceUtils.setAttributeToMarkupSvg(rect, 'd', path);
            namespaceUtils.setAttributeToMarkupSvg(rect, 'stroke-width', strokeWidth);
            namespaceUtils.setAttributeToMarkupSvg(rect, 'stroke', strokeColor);
            namespaceUtils.setAttributeToMarkupSvg(rect, 'transform', transform);
            namespaceUtils.setAttributeToMarkupSvg(rect, 'fill', fillColor);
            namespaceUtils.updateMarkupPathSvgHitarea(rect, editor);
        }
    };
    ...
    proto.cloneShape = function(clone) {
        ...
        clone.textShape = namespaceUtils.createMarkupTextSvg();
        clone.rectShape = namespaceUtils.createMarkupPathSvg();
        clone.shape = namespaceUtils.createMarkupGroupSvg([clone.rectShape, clone.textShape]);
        clone.bindDomEvents();
    };
    ...
    proto.getPath = function() {
        ...
        var w = this.size.x + 2*strokeWidth;
        var h = this.size.y + 2*strokeWidth;
        var x =-w * 0.5;
        var y =-h * 0.5;
    ...
    proto.getBoundingRect = function() {
        ...
        var margin = 1.5*width + namespaceUtils.EDIT_FRAME_DEFAULT_MARGIN;
    ...
    namespace.MarkupCallout = MarkupCallout;
...
(function(){ 'use strict';
    ...
    function MarkupDimension(id, editor) {
        ...
        this.type = namespace.MARKUP_TYPE_DIMENSION;
        this.constraintHeight = true;
        ...
        this.shape = namespaceUtils.createMarkupPathSvg();
        this.text = namespaceUtils.createMarkupTextSvg();
    ...
    MarkupDimension.prototype = Object.create(namespace.Markup.prototype);
    ...
    proto.getEditMode = function() {
        ...
        return new namespace.EditModeDimension(this.editor);
    };
    ...
    proto.setRotation = function(angle) {
        ...
        if (namespaceUtils.radiansToDegrees(angle) === 90) {
            angle = namespaceUtils.degreesToRadians(-90);
        }
    ...
    proto.updateStyle = function() {
        ...
        namespaceUtils.setAttributeToMarkupSvg(shape, 'd', this.getPath().join(' '));
        namespaceUtils.setAttributeToMarkupSvg(shape, 'stroke-width', strokeWidth / 2);
        namespaceUtils.setAttributeToMarkupSvg(shape, 'stroke', strokeColor);
        namespaceUtils.setAttributeToMarkupSvg(shape, 'fill', strokeColor);
        namespaceUtils.setAttributeToMarkupSvg(shape, 'transform', transform);
        namespaceUtils.updateMarkupPathSvgHitarea(shape, this.editor);
    ...
    proto.rebuildTextSvg = function(value) {
        ...
        var lineSize = namespaceUtils.measureTextLines([value], style, editor)[0]; // Only one line for measurement
        ...
        namespaceUtils.setAttributeToMarkupSvg(text, 'font-family', style['font-family']);
        namespaceUtils.setAttributeToMarkupSvg(text, 'font-size', style['font-size']);
        namespaceUtils.setAttributeToMarkupSvg(text, 'font-weight', style['font-weight']);
        namespaceUtils.setAttributeToMarkupSvg(text, 'font-style', style['font-style']);
        namespaceUtils.setAttributeToMarkupSvg(text, 'fill', strokeColor);
        namespaceUtils.setMarkupTextSvgTransform(text, backgroundTransform, textTransform); 
        namespaceUtils.updateMarkupTextSvgBackground(text, textSize.x, textSize.y, backgroundColor);
        namespaceUtils.updateMarkupTextSvgClipper(text, textSize.x, textSize.y);
        namespaceUtils.updateMarkupTextSvgHitarea(text, textSize.x, textSize.y, editor);
    };
    ...
    proto.getTextTransform = function(offset, inverse) {
        ...
        if (namespaceUtils.radiansToDegrees(this.rotation) === 90) {
            this.rotation = namespaceUtils.degreesToRadians(-90);
        }
    ...
    proto.generatePoint3d = function(idTarget) {
        ...
        var point2d = namespaceUtils.checkLineSegment(firstAnchor.x, firstAnchor.y, firstAnchor.x + direction.x * 200, firstAnchor.y + direction.y * 200, idTarget);
        var point3d = point2d && this.viewer.clientToWorld(point2d.x, point2d.y);
    ...
    proto.cloneShape = function(clone) {
        ...
        clone.shape = namespaceUtils.createMarkupPathSvg();
        clone.text = namespaceUtils.createMarkupTextSvg();
    ...
    namespace.MarkupDimension = MarkupDimension;
...
(function(){ 'use strict';
    ...
    proto.updateStyle = function() {
        ...
        this.boundingBox = { x: this.size.x + strokeWidth*2, y: this.size.y + strokeWidth*2 };
    };
...
(function(){ 'use strict';
    ...
    function MarkupTool() {
        ...
        this.handleButtonDown = function(event, button) {
            if (this.allowNav || (this.is2d && avp.isRightClick(event, this.viewer.navigation))) {
...
(function(){ 'use strict';
    ...
    function MarkupsCore(viewer, options) {
        ...
        Autodesk.Viewing.Private.injectCSS('extensions/Markups/Markups.css');
    ...
    MarkupsCore.prototype.getStrokeWidth = function() {
        ...
        if (!this.initialStrokeWidth || (this.viewer.model && !this.viewer.model.is2d())) {
            this.initialStrokeWidth = this.sizeFromClientToMarkups(0, namespaceUtils.MARKUP_DEFAULT_STROKE_WIDTH_IN_PIXELS).y;
        }
    ...
    MarkupsCore.prototype.getFontWidth = function() {
        ...
        if (!this.initialFontWidth || (this.viewer.model && !this.viewer.model.is2d())) {
            this.initialFontWidth = this.sizeFromClientToMarkups(0, namespaceUtils.MARKUP_DEFAULT_FONT_WIDTH_IN_PIXELS).y;
        }
    ...
    Autodesk.Viewing.Extensions.Markups.Core.MarkupsCore.prototype.onUnitsCalibrationStarts = function(event) {
        if (this.duringEditMode) {
            this.hide();
        }
    };
    ...
    MarkupsCore.prototype.loadMarkups = function (markupString, layerId) {
        ...
        var metadata = parent.childNodes[0] ? parent.childNodes[0].childNodes[0] : null;
        var versionAttr = metadata && metadata.getAttribute('data-model-version');
        var version = (typeof versionAttr === 'string') ? parseFloat(versionAttr) : null;
...
(function(){ 'use strict';
    ...
    function CreateCallout(editor, id, position, size, text, style, isFrameUsed) {
        ...
        namespace.EditAction.call(this, editor, 'CREATE-CALLOUT', id);
    ...
    CreateCallout.prototype = Object.create(namespace.EditAction.prototype);
    ...
    proto.redo = function () {
        ...
        var callout = new namespace.MarkupCallout(this.targetId, editor, size);
    ...
    namespace.CreateCallout = CreateCallout;
...
(function(){ 'use strict';
    ...
    function CreateDimension(editor, id, firstAnchor, secondAnchor, text, style) {
        ...
        namespace.EditAction.call(this, editor, 'CREATE-DIMENSION', id);
    ...
    CreateDimension.prototype = Object.create(namespace.EditAction.prototype);
    ...
    proto.redo = function() {
        ...
        var editor = this.editor;
        var dimension = new namespace.MarkupDimension(this.targetId, editor);
    ...
    namespace.CreateDimension = CreateDimension;
...
(function(){ 'use strict';
    ...
    function DeleteCallout(editor, callout) {
        ...
        namespace.EditAction.call(this, editor, 'DELETE-CALLOUT', callout.id);

        var position = {x: callout.position.x, y: callout.position.y};
        var size = {x: callout.size.x, y: callout.size.y};

        this.createCallout = new namespace.CreateCallout(
            editor,
            callout.id,
            position,
            size,
    ...
    DeleteCallout.prototype = Object.create(namespace.EditAction.prototype);
    ...
    namespace.DeleteCallout = DeleteCallout;
...
(function(){ 'use strict';
    ...
    function DeleteDimension(editor, dimension) {
        ...
        // the firstAnchor. 
        namespace.EditAction.call(this, editor, 'DELETE-DIMENSION', dimension.id);
        this.createDimension = new namespace.CreateDimension(
            editor,
            dimension.id,
    ...
    DeleteDimension.prototype = Object.create(namespace.EditAction.prototype);
    ...
    namespace.DeleteDimension = DeleteDimension;
...
(function(){ 'use strict';
    ...
    function SetCallout(editor, markup, position, size, text, isFrameUsed) {
        ...
        namespace.EditAction.call(this, editor, 'SET-CALLOUT', markup.id);
    ...
    SetCallout.prototype = Object.create(namespace.EditAction.prototype);
    ...
    namespace.SetCallout = SetCallout;
...
(function(){ 'use strict';
    ...
    function SetDimension(editor, dimension, firstAnchor, secondAnchor, text) {
        ...
        namespace.EditAction.call(this, editor, 'SET-DIMENSION', dimension.id);
    ...
    SetDimension.prototype = Object.create(namespace.EditAction.prototype);
    ...
    namespace.SetDimension = SetDimension;
...
(function(){ 'use strict';
    ...
    function EditModeCallout(editor) {
        ...
        namespace.EditMode.call(this, editor, namespace.MARKUP_TYPE_CALLOUT, styleAttributes);

        this.style['fill-opacity'] = 1.0;
        this.style['fill-color'] = '#ffffff';
        var helper = new namespace.EditorTextInput(this.viewer.container, this.editor, false, 'Write Something', 260);
    ...
    EditModeCallout.prototype = Object.create(namespace.EditMode.prototype);
    ...
    proto.deleteMarkup = function(markup, cantUndo) {
        ...
        markup = markup || this.selectedMarkup;
        if (markup && markup.type === this.type) {
            var deleteCallout = new namespace.DeleteCallout(this.editor, markup);
    ...
    proto.onMouseDown = function() {
        ...
        var createCallout = new namespace.CreateCallout(
            editor,
            editor.getId(),
            position,
            size,
    ...
    proto.onHelperSetActive = function(event) {
        ...
        if (markup) {
            markup.setIsFilledFrameVisible(!databag.isActive);
        }
    ...
    proto.onHelperTextChange = function(event) {
        ...
        if (dataBag.newText === '') {
            ...
            {
                var deleteCallout = new namespace.DeleteCallout(this.editor, textMarkup);
                deleteCallout.execute();
                this.editor.selectMarkup(null);
                return;
            }
        ...
        // Text change action //
        var setCallout = new namespace.SetCallout(
            this.editor,
            textMarkup,
            textMarkup.position,
            textMarkup.size,
    ...
    namespace.EditModeCallout = EditModeCallout;
...
(function(){ 'use strict';
    ...
    namespace.FINISHED_CALIBRATION_FOR_DIMENSION_EVENT = 'finished_calibration_for_dimension_event';
    ...
    function EditModeDimension(editor) {
        ...
        var styleAttributes = ['stroke-width', 'stroke-color', 'stroke-opacity', 'font-size', 'font-family', 'font-style', 'font-weight'];
        namespace.EditMode.call(this, editor, namespace.MARKUP_TYPE_DIMENSION, styleAttributes);
    ...
    EditModeDimension.prototype = Object.create(namespace.EditMode.prototype);
    ...
    proto.deleteMarkup = function(markup, cantUndo) {
        ...
        markup = markup || this.selectedMarkup;
        if (markup && markup.type == this.type) {
            var deleteDimension = new namespace.DeleteDimension(this.editor, markup);
    ...
    proto.creationBegin = function() {
        namespace.EditMode.prototype.creationBegin.call(this);
    };
    ...
    proto.pickFirstAnchor = function() {
        ...
        var create = new namespace.CreateDimension(editor, dimensionId, this.firstAnchor, null, this.currentText, this.style);
        create.execute();
    ...
    proto.pickSecondAnchor = function(mouseDown) {
        ...
        var setDimension = new namespace.SetDimension(editor, selectedMarkup, this.firstAnchor, secondAnchor, selectedMarkup.currentText);
        setDimension.execute();

        var setStyle = new namespace.SetStyle(editor, selectedMarkup, this.style);
        setStyle.execute();
    ...
    proto.measureTextLine = function(text, markup, editor) {
        ...
        return namespaceUtils.measureTextLines([text + '|'], this.style, editor)[0];
    ...
    proto.updateTextBox = function(markup, size) {
        ...
        if (!this.textInputHelper) {
            this.textInputHelper = new namespace.EditorTextInput(this.viewer.container, this.editor, true, markup.initialText, MAX_LETTERS);
    ...
    proto.getTextAreaTransform = function(markup, size) {
        ...
        var rotation = namespaceUtils.radiansToDegrees(markup.rotation) % 360;
    ...
    proto.onHelperTextChange = function(event) {
        ...
        var setStyle = new namespace.SetStyle(editor, markup, textStyle);
        setStyle.execute();

        var setDimension = new namespace.SetDimension(editor, markup, markup.firstAnchor, markup.secondAnchor, dataBag.newText);
        setDimension.execute();
    ...
    proto.onSave = function() {
        ...
        if (this.isTextInputHelperActive()) {
            var editor = this.editor;
            editor.actionManager.removeEventListener(namespace.EVENT_HISTORY_CHANGED, this.onHistoryChangeBinded);
    ...
    namespace.EditModeDimension = EditModeDimension;
...
(function(){ 'use strict';
    ...
    function EditModeFreehand(editor) {
        ...
        var styleAttributes = ['stroke-width', 'stroke-color', 'stroke-opacity'];
        namespace.EditModePen.call(this, editor, namespace.MARKUP_TYPE_FREEHAND, styleAttributes);
    }
...
(function() { 'use strict';
    ...
    function EditModeHighlight(editor) {
        ...
        var styleAttributes = ['stroke-width', 'stroke-color', 'stroke-opacity'];
        namespace.EditModePen.call(this, editor, namespace.MARKUP_TYPE_HIGHLIGHT, styleAttributes);
...
(function(){ 'use strict';
    ...
    function EditorTextInput(parentDiv, editor, singleLine, defaultText, maxLength) {
        ...
        this.onTextAreaResizeBinded = this.onTextAreaResize.bind(this);
        this.textArea.addEventListener('keydown', this.onKeyHandlerBinded);
        this.textArea.addEventListener('mouseup', this.onTextAreaResizeBinded);
    ...
    proto.destroy = function() {
        ...
        this.textArea.removeEventListener('mouseup', this.onTextAreaResizeBinded);
        this.setInactive();
    };
    ...
    proto.onCameraChanged = function(event) {
        ...
        this.textMarkup.style = namespaceUtils.cloneStyle(this.style);
    ...
    // There is no resize event for textarea, so we can just update the size whenever we suspect happend a resize - on a mouseup event.
    proto.onTextAreaResize = function() {
        var width = parseFloat(this.textArea.style.width);
        var height = parseFloat(this.textArea.style.height);
        this.textMarkup.size = this.editor.sizeFromClientToMarkups(width, height);

        var ox = parseFloat(this.textArea.style.left);
        var oy = parseFloat(this.textArea.style.top);
        this.textMarkup.position = this.editor.positionFromClientToMarkups(ox + (width * 0.5), oy + (height * 0.5));
    };
