...
class NewDataManagementShow extends MultiModelExtensionBase {
  ...
  static get ExtensionId() {
    ...
    return 'Viewing.Extension.NewDataManagementShow'
  }
  /////////////////////////////////////////////////////////////////
  // Load callback
  //
  ...
  load() {
    ...
    console.log('Viewing.Extension.NewDataManagementShow loaded')
  ...
  unload() {
    ...
    console.log('Viewing.Extension.NewDataManagementShow unloaded')
...
Autodesk.Viewing.theExtensionManager.registerExtension(
  NewDataManagementShow.ExtensionId,
  NewDataManagementShow)
